    ...
    return (
        <div className="header-section">
            ...
            <div className="navbar-end ">
                ...
                
                {
                    user?
                        <div className="user-info flex justify-center items-center">
                            ...
                            <div className="name font-bold"><h2>{user.displayName}</h2></div>
                ...
                {
                    user?
                        <button onClick={handleSignOut} className="btn btn-ghost text-lg">Log Out</button>
                        :
                        <Link to={"/login"}><button className="btn btn-ghost text-lg">Login/Register</button></Link>
                }
